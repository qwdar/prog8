...
"""Verify that starting micoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start micoin with -h for help text")
        ...
        self.log.info("Start micoin with -version for version information")
        ...
        self.log.info("Start micoind with -fakearg to make sure it does not start")
