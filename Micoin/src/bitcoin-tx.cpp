...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " micoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  micoin-tx [options] <hex-tx> [commands]  Update hex-encoded micoin transaction\n" +
            "or:     micoin-tx [options] -create [commands]   Create hex-encoded micoin transaction\n" +
            "\n";
