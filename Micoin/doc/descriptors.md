# Support for Output Descriptors in Micoin Core

Since Micoin Core v0.17, there is support for Output Descriptors. This is a
...
on Micoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Micoin Core wallets, a convenience function `combo` is
